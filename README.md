...
| 13 | Fama-French 三因子模型 | **多因子模型入门** | SMB构建 · HML构建 · OLS回归 · 因子显著性检验 |
| 14 | Fama-French 五因子模型 | **多因子模型进阶** | RMW盈利因子 · CMA投资因子 · 三因子vs五因子对比 · 调整R²分析 |
| 15 | 因子模型总结 | **因子投资全景** | CAPM到五因子演进 · 因子构建方法 · 因子选股 · 因子择时 · 因子组合构建 |
| 16 | BS公式与Greeks | **期权定价基础** | BS公式手写实现 · Greeks计算与可视化 · Put-Call Parity · 期权风险敏感度 |
| 17 | 蒙特卡洛期权定价 | **随机模拟定价** | GBM路径模拟 · 对偶变量法 · 控制变量法 · 收敛性分析 · 方差缩减 |
| 18 | 亚式期权定价 | **路径依赖期权** | 算术vs几何平均 · 观察频率影响 · 几何平均解析解 · MC定价路径依赖期权 |
| 19 | VaR / CVaR | **风险度量** | 历史模拟法 · 参数法 · 蒙特卡洛法 · CVaR优势 · 风险管理 |
| 20 | Markowitz 均值方差优化 | **组合优化理论** | 有效前沿 · 最大夏普比组合 · 最小方差组合 · 分散化原理 |
| 21 | 组合优化器 | **实战组合构建** | 选股逻辑 · 有效前沿 · 最优权重 · 回溯测试 · 权重饼图 · 与等权对比 |
| 19 | VaR与CVaR | **风险价值度量** | 历史模拟法 · 参数法 · 蒙特卡洛法 · CVaR · Kupiec回测检验 |
| 20 | Markowitz 组合优化 | **均值方差优化** | 有效前沿 · MVP · MSR · scipy优化 · PyPortfolioOpt · 分散化原理 |
...
10. **蒙特卡洛方法** — 随机路径模拟 · 方差缩减技术 · 收敛性分析
11. **路径依赖期权** — 亚式期权定价 · 算术vs几何平均 · 观察频率影响
12. **风险度量** — VaR / CVaR · 历史模拟法 · 参数法 · 蒙特卡洛法
13. **组合优化** — Markowitz 均值方差 · 有效前沿 · 最优权重 · 回溯测试
12. **风险度量** — VaR（历史/参数/蒙特卡洛）· CVaR · Kupiec回测检验
13. **组合优化** — Markowitz 均值方差 · 有效前沿 · MVP/MSR · PyPortfolioOpt · 分散化原理
